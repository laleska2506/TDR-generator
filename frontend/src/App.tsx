...
export default function App() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      console.error('Error generating TDR:', err);
      setError(err?.message ?? 'Hubo un error al generar el TDR. Por favor intenta de nuevo.');
    } finally {
      setLoading(false);
    }
  };
    ...
    const doc = new Document({
      sections: [{
        ...
        children: [
          ...
          new Paragraph({ text: "" }),
          new Paragraph({
            children: [new TextRun({ text: "T�0RMINOS DE REFERENCIA PARA LA CONTRATACI�N DE SERVICIOS Y CONSULTORÍAS", bold: true, size: 28 })],
          ...
          new Table({
            ...
            rows: [
              new TableRow({
                children: [
                  new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: "�rgano y/o Unidad Orgánica:", bold: true })] })] }),
          ...
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "I. FINALIDAD P�aBLICA", bold: true })] }),
          new Paragraph({ text: tdrData.finalidadPublica, alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "II. OBJETIVO DE LA CONTRATACI�N", bold: true })] }),
          ...
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "V. LUGAR Y PLAZO DE EJECUCI�N", bold: true })] }),
          ...
          new Paragraph({ text: "El contratista deberá mantener estricta confidencialidad sobre la información a la que tendrá acceso durante la ejecución del servicio.", alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
          ...
          new Paragraph({ text: "Los derechos intelectuales de los productos y documentos elaborados por el proveedor que resulte seleccionado son propiedad de la Entidad.", alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "XIII. PENALIDADES POR MORA", bold: true })] }),
          new Paragraph({ text: "Penalidad diaria = 0.10 x monto / (F x plazo). Donde F = 0.40 para bienes y servicios.", alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "XIV. RESOLUCI�N CONTRACTUAL", bold: true })] }),
          new Paragraph({ text: "Cualquiera de las partes puede resolver el contrato, de conformidad con el numeral 68.1 al 68.5 del artículo 68 de la Ley N° 32069, Ley General de Contrataciones Públicas.", alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "XV. SANCIONES", bold: true })] }),
          new Paragraph({ text: "El proveedor se compromete a cumplir las obligaciones derivadas de la orden de compra, orden de servicio o el contrato, siendo aplicable lo previsto en la Ley según el artículo 87 al 92.", alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "XVI. APLICACI�N SUPLETORIA", bold: true })] }),
          new Paragraph({ text: "A la aplicación de la Ley de Contrataciones y su Reglamento � Ley No. 32069, también se considera el Código Civil vigente.", alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "XVII. MEDIDAS DE SEGURIDAD EN LA PRESTACI�N DEL SERVICIO", bold: true })] }),
          new Paragraph({ text: "No aplica.", alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "XVIII. SOLUCI�N DE CONTROVERSIAS", bold: true })] }),
          new Paragraph({ text: "Todas las controversias se resuelven mediante conciliación, conforme lo dispuesto en el numeral 81.3 del artículo 81 de la Ley N° 32069.", alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "XIX. OBLIGACI�N ANTICORRUPCI�N", bold: true })] }),
          new Paragraph({ text: "EL CONTRATISTA declara y garantiza no haber ofrecido, negociado, prometido o efectuado ningún pago o entrega de cualquier beneficio o incentivo ilegal.", alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "XX. CLÁUSULA ANTISOBORNO", bold: true })] }),
          new Paragraph({ text: "El contratista declara conocer los compromisos antisoborno de la SUNASS y se compromete a actuar con integridad.", alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "XXI. CLAUSULA GESTION DE RIESGO", bold: true })] }),
          new Paragraph({ text: "LAS PARTES realizan la gestión de riesgos de acuerdo con lo establecido en el presente contrato.", alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "XXII. CLAUSULA DE VICIOS OCULTOS", bold: true })] }),
          new Paragraph({ text: "El contratista es responsable por la calidad ofrecida y por los vicios ocultos por un plazo no menor de un año.", alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
          new Paragraph({ children: [new TextRun({ text: "XXIII. CLAUSULA MODIFICACION CONTRACTUAL", bold: true })] }),
          new Paragraph({ text: "Las partes pueden acordar modificaciones al contrato menor, siempre que permitan alcanzar su finalidad de manera oportuna y eficiente.", alignment: AlignmentType.JUSTIFIED }),
          new Paragraph({ text: "" }),
    ...
    <div className="min-h-screen bg-[#F8F7F4] text-[#1A1A1A] font-sans selection:bg-emerald-100">
      ...
      <header className="border-b border-black/5 bg-white/70 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <div className="flex items-center gap-2">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all ${step === 1 ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30' : 'bg-emerald-100 text-emerald-700'
                }`}>1</div>
              <span className={`text-xs font-bold uppercase tracking-wider ${step === 1 ? 'text-emerald-700' : 'text-black/30'}`}>Datos</span>
            </div>
            <div className={`w-12 h-0.5 rounded transition-colors ${step === 2 ? 'bg-emerald-500' : 'bg-black/10'}`} />
            <div className="flex items-center gap-2">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all ${step === 2 ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/30' : 'bg-black/5 text-black/30'
                }`}>2</div>
              <span className={`text-xs font-bold uppercase tracking-wider ${step === 2 ? 'text-emerald-700' : 'text-black/30'}`}>Documento</span>
            </div>
          </div>
      ...
      <main className="relative z-10 px-6 py-12 min-h-[calc(100vh-4rem)] flex items-center justify-center">
              ...
              >
                <div className="text-center mb-10">
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-emerald-50 border border-emerald-100 rounded-full mb-5">
                    ...
                    <span className="text-[10px] font-bold text-emerald-700 uppercase tracking-widest">Generador Inteligente</span>
                  </div>
                  <h1 className="text-4xl md:text-5xl font-serif font-medium mb-4 tracking-tight">
                    Crea tus Términos de Referencia
                  </h1>
                  <p className="text-black/50 text-lg max-w-2xl mx-auto">
                    Describe lo que necesitas y nuestra IA redactará un documento formal siguiendo los estándares institucionales de SUNASS.
                  </p>
                </div>
                ...
                <div className="w-full max-w-[720px]">
                  <div className="bg-white rounded-[2rem] shadow-xl shadow-black/5 border border-black/5 overflow-hidden">
                      ...
                      <div className="space-y-5">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                          <div className="space-y-2">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-black/40 ml-1">
                            ...
                            <input
                              ...
                              className="w-full px-5 py-3.5 rounded-2xl border border-black/10 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/5 outline-none transition-all bg-black/[0.02] font-medium"
                            />
                          </div>
                            ...
                            <div className="flex p-1.5 bg-black/[0.02] rounded-2xl border border-black/10">
                              {[1, 2, 3, 4, 5].map((num) => (
                                <button
                                  ...
                                  className={`flex-1 py-2.5 rounded-xl transition-all text-sm font-bold ${numEntregables === num
                    ...
                    {/* ���� Divider ���� */}
                    <div className="mx-8 my-6 border-t border-dashed border-black/8" />
                    ...
                    <div className="px-8">
                      <div className="flex items-center gap-3 mb-5">
                        ...
                        <div>
                          <h2 className="text-base font-bold text-black/80">Archivos Adjuntos</h2>
                          <p className="text-[10px] text-black/40 font-medium uppercase tracking-wider">Opcional: CV del consultor y TDRs de referencia</p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="space-y-3">
                          <p className="text-xs font-bold text-black/50 ml-1">Perfil del Consultor</p>
                          <div className="relative group">
                            <input
                              ...
                              accept=".pdf,.txt"
                            />
                            <div className={`border-2 border-dashed rounded-2xl p-6 text-center transition-all ${cvName
                              ? 'border-emerald-500 bg-emerald-50/50'
                              : 'border-black/10 group-hover:border-blue-400 bg-black/[0.01]'
                              }`}>
                              {cvName ? (
                                <div className="space-y-1.5">
                                  ...
                                  <p className="font-bold text-xs text-emerald-800 truncate px-2">{cvName}</p>
                                  <p className="text-[9px] text-emerald-600/60 font-bold uppercase">Cargado</p>
                                </div>
                              ) : (
                                <div className="space-y-1.5">
                                  <Upload className="w-6 h-6 text-black/15 mx-auto" />
                                  <p className="text-xs font-bold text-black/50">Subir CV</p>
                                  <p className="text-[9px] text-black/30 font-medium uppercase tracking-widest">PDF o Texto</p>
                                </div>
                              )}
                            </div>
                          </div>
                          {cvName && (
                            <button
                              ...
                              className="w-full flex items-center justify-center gap-1.5 py-1.5 text-[10px] text-red-500 hover:text-red-700 transition-colors font-bold uppercase tracking-wider"
                            >
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-between ml-1">
                            <p className="text-xs font-bold text-black/50">TDRs de Referencia</p>
                            <span className="text-[10px] font-bold text-black/20">{examples.length}/5</span>
                          </div>
                          <div className="space-y-2">
                            {examples.length > 0 && (
                              <div className="space-y-1.5 max-h-[120px] overflow-y-auto">
                                {examples.map((ex, idx) => (
                                  <div
                                    key={idx}
                                    className="flex items-center justify-between px-3 py-2 bg-black/[0.02] rounded-xl border border-black/5 group"
                                  >
                                    <div className="flex items-center gap-2 overflow-hidden">
                                      <FileText className="w-3.5 h-3.5 text-black/20 flex-shrink-0" />
                                      <span className="text-[11px] font-bold text-black/60 truncate">{ex.name}</span>
                                    </div>
                                    <button
                                      onClick={() => setExamples(prev => prev.filter((_, i) => i !== idx))}
                                      className="p-1 hover:bg-red-50 hover:text-red-600 rounded-lg transition-colors text-black/20"
                                    >
                            ...
                            {examples.length < 5 && (
                              <div className="relative group">
                                <input
                                  ...
                                  accept=".pdf,.txt"
                                />
                                <div className={`border-2 border-dashed border-black/10 rounded-2xl text-center group-hover:border-amber-400 bg-black/[0.01] transition-all ${examples.length > 0 ? 'py-3' : 'p-6'}`}>
                                  <Plus className="w-5 h-5 text-black/15 mx-auto mb-1" />
                                  <p className="text-[9px] font-bold text-black/40 uppercase tracking-widest">Añadir ejemplos</p>
                                </div>
                              </div>
                            )}
                          </div>
                    ...
                    {error && (
                      <div className="mx-8 mt-6 bg-red-50 border border-red-200 text-red-700 rounded-2xl px-5 py-3.5 text-sm font-medium flex items-start gap-3">
                        <span className="mt-0.5 text-red-400">�a�</span>
                        <span>{error}</span>
                      </div>
                    )}
                    ...
                    <div className="p-8 pt-6">
                      <button
                        ...
                        className="group relative w-full px-8 py-5 bg-emerald-600 text-white rounded-2xl font-bold flex items-center justify-center gap-3 hover:bg-emerald-700 disabled:opacity-40 disabled:cursor-not-allowed transition-all shadow-xl shadow-emerald-600/25 overflow-hidden"
                      >
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
                        {loading ? (
                          <>
                            <Loader2 className="w-6 h-6 animate-spin" />
                            <span className="text-lg">Generando documento...</span>
                          </>
                        ) : (
                          <>
                  ...
                  <div className="mt-6 text-center">
                    <p className="text-[10px] font-bold text-black/20 uppercase tracking-widest">
                      Impulsado por Gemini AI · Formato SUNASS
                    </p>
                  </div>
                </div>
              </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                  ...
                  <div className="lg:col-span-3 sticky top-24 space-y-4 hidden lg:block">
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-black/5">
                      <h4 className="text-[10px] font-bold uppercase tracking-widest text-black/40 mb-4">
                    ...
                    <div className="bg-white shadow-2xl rounded-sm overflow-hidden border border-black/5 overflow-x-auto">
                      ...
                      >
                        ...
                        <div className="flex justify-between items-start mb-12 border-b-2 border-[#E30613] pb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col leading-tight border-l border-black/20 pl-3">
                              <span className="text-[9px] text-black font-bold uppercase tracking-tighter">
                                Superintendencia Nacional de
                              </span>
                              <span className="text-xl font-black text-[#E30613] tracking-tighter">
                        ...
                        <h2 className="text-center font-bold text-lg mb-8 uppercase underline">
                          T�0RMINOS DE REFERENCIA PARA LA CONTRATACI�N DE SERVICIOS Y CONSULTORÍAS
                        </h2>
                        ...
                        <table className="w-full border-collapse border border-black mb-8">
                          <tbody>
                            <tr>
                              <td className="border border-black p-2 font-bold w-1/3 bg-gray-50">
                                �rgano y/o Unidad Orgánica:
                              </td>
                        ...
                        <div className="space-y-8">
                          <section id="sec-i">
                            <h3 className="font-bold mb-2">I. FINALIDAD P�aBLICA</h3>
                            {isEditing ? (
                              <textarea
                          ...
                          <section id="sec-ii">
                            <h3 className="font-bold mb-2">II. OBJETIVO DE LA CONTRATACI�N</h3>
                            {isEditing ? (
                              <textarea
                                  ...
                                  <li className="list-[lower-alpha]">
                                    {isEditing ? (
                                      <input
                                        ...
                                        onChange={(e) =>
                                          updateTdrField('perfil', { ...tdrData!.perfil, experiencia: e.target.value })
                                        }
                                      />
                          ...
                          <section id="sec-v">
                            <h3 className="font-bold mb-2">V. LUGAR Y PLAZO DE EJECUCI�N</h3>
                            <div className="space-y-2">
                              <p>
                                <span className="font-bold">LUGAR: </span>
                                {isEditing ? (
                                  <input
                                    className="bg-emerald-50 p-1 outline-none w-full mt-1"
                                    value={tdrData?.lugar}
                                    onChange={(e) => updateTdrField('lugar', e.target.value)}
                                  />
                                ) : tdrData?.lugar}
                              </p>
                              <p>
                                ...
                                {isEditing ? (
                                  <input
                                    className="bg-emerald-50 p-1 outline-none w-full mt-1"
                                    value={tdrData?.plazo}
                                    onChange={(e) => updateTdrField('plazo', e.target.value)}
                                  />
                                ) : tdrData?.plazo}
                              </p>
                            </div>
                                      ...
                                      {isEditing ? (
                                        <input
                                          ...
                                          onChange={(e) => {
                                            ...
                                            newEnts[idx] = { ...newEnts[idx], descripcion: e.target.value };
                                    ...
                                    <td className="border border-black p-2 text-center">
                                      {isEditing ? (
                                        <input
                                          ...
                                          onChange={(e) => {
                                            const newEnts = [...tdrData.entregables];
                                            newEnts[idx] = { ...newEnts[idx], plazo: e.target.value };
                                            updateTdrField('entregables', newEnts);
                                          }}
                                        />
                                      ) : ent.plazo}
                          ...
                          <section>
                            ...
                            <p className="text-justify">
                              La conformidad será otorgada de acuerdo con el Artículo 144 del Reglamento de la Ley General
                              de Contrataciones Públicas, por el/la Jefe/a de la Unidad de Modernización de la SUNASS,
                              para que se otorgue la conformidad, el Área Usuaria deberá verificar el cumplimiento de cada
                              una de las actividades establecidas en los términos de referencia por parte del Contratista,
                              caso contrario no aceptará y observará al Contratista.
                            </p>
                          </section>

                          <section>
                            <h3 className="font-bold mb-2">VIII. SUPERVISI�N</h3>
                            <p className="text-justify">
                              La supervisión del servicio será realizada por el/la Jefe/a de la Unidad de Modernización.
                            </p>
                          </section>
                          ...
                          <section id="sec-x">
                            ...
                            <p className="text-justify">
                              El contratista deberá mantener estricta confidencialidad sobre la información a la que tendrá
                              acceso durante la ejecución del servicio. Asimismo, no podrá disponer de ésta para fines
                              distintos al servicio que presta. El contratista deberá de tener conocimiento de las
                              "Disposiciones de seguridad de la información para proveedores" que serán comunicadas por la
                              SUNASS si por la contratación el proveedor tiene acceso a algún activo de información de la
                              SUNASS (sistemas de información, instalaciones de procesamiento, entre otros). El contratista
                              deberá de enviar al correo electrónico del personal responsable de la contratación del
                              servicio la declaración jurada de compromiso de confidencialidad de proveedores de la Sunass
                              firmada. El proveedor podrá ser evaluado de acuerdo con los lineamientos de seguridad de la
                              información.
                            </p>
                          </section>
                          ...
                          <section>
                            ...
                            <p className="text-justify">
                              ...
                              ofertado por un plazo no menor de un (01) año, contado a partir del día siguiente de la
                          ...
                          <section id="sec-xiii">
                            ...
                            <p className="text-justify">
                              ...
                              cada día de atraso que le sea imputable. La penalidad se calcula de acuerdo con la siguiente
                              fórmula:
                            </p>
                          ...
                          <section>
                            <h3 className="font-bold mb-2">XIV. RESOLUCI�N CONTRACTUAL</h3>
                            <p className="text-justify">
                              Cualquiera de las partes puede resolver el contrato, de conformidad con el numeral 68.1 al
                              68.5 del artículo 68 de la Ley N° 32069, Ley General de Contrataciones Públicas. De
                              encontrarse en alguno de los supuestos de resolución del contrato, LAS PARTES proceden de
                              acuerdo con lo establecido en el artículo 122 del Reglamento de la Ley N° 32069, aprobado
                          ...
                          <section>
                            ...
                            <p className="text-justify">
                              El proveedor se compromete a cumplir las obligaciones derivadas de la orden de compra, orden
                              de servicio o el contrato, siendo aplicable lo previsto en la Ley según el artículo 87 al 92,
                              así como del reglamento de la LEY GENERAL DE CONTRATACIONES P�aBLICAS.
                            </p>
                          </section>

                          <section>
                            <h3 className="font-bold mb-2">XVI. APLICACI�N SUPLETORIA</h3>
                            <p className="text-justify">
                              A la aplicación de la Ley de Contrataciones y su Reglamento � Ley No. 32069, también se
                              considera el Código Civil vigente, teniendo en cuenta ese orden de prelación, según
                              corresponda, siempre que no se contradiga con las disposiciones establecidas en los términos
                              de referencia.
                            </p>
                          </section>

                          <section>
                            <h3 className="font-bold mb-2">XVII. MEDIDAS DE SEGURIDAD EN LA PRESTACI�N DEL SERVICIO</h3>
                            <p className="text-justify">No aplica.</p>
                          </section>

                          <section>
                            <h3 className="font-bold mb-2">XVIII. SOLUCI�N DE CONTROVERSIAS</h3>
                            <p className="text-justify">
                              Todas las controversias que surjan entre las partes sobre la validez, nulidad,
                              interpretación, ejecución, terminación o eficacia de los contratos menores se resuelven
                              mediante conciliación, conforme lo dispuesto en el numeral 81.3 del artículo 81 de la Ley
                              N° 32069 Ley General de Contrataciones Públicas y Art. 330 Reglamento.
                            </p>
                          </section>

                          <section id="sec-xix">
                            <h3 className="font-bold mb-2">XIX. OBLIGACI�N ANTICORRUPCI�N</h3>
                            <p className="text-justify">
                              ...
                              cualquier servidor de la entidad contratante. Asimismo, EL CONTRATISTA se obliga a mantener
                              una conducta proba e íntegra durante la vigencia del contrato y a abstenerse de ofrecer,
                              negociar, prometer o dar regalos, cortesías, invitaciones, donativos o cualquier beneficio
                              o incentivo ilegal.
                            </p>
                          </section>
                          ...
                          <section>
                            ...
                            <p className="text-justify">
                              a. El contratista declara conocer los compromisos antisoborno de la SUNASS, el cual se
                              establece en su Política antisoborno y se encuentra disponible en el portal web de la SUNASS.
                              b. El contratista declara no haber, directa o indirectamente, ofrecido, negociado o efectuado
                              pago o, en general, entregado beneficio o incentivo ilegal en relación al servicio a
                              prestarse. c. El contratista se compromete a denunciar cualquier intento de soborno a través
                              del canal de denuncias de la SUNASS.
                            </p>
                          </section>
                          ...
                          <section>
                            ...
                            <p className="text-justify">
                              ...
                              contrato/orden de servicio u compra y los documentos que lo conforman, a fin de tomar
                              decisiones informadas, aprovechando el impacto de riesgos positivos y disminuyendo la
                              probabilidad de los riesgos negativos y su impacto durante la ejecución contractual.
                            </p>
                          </section>
                          ...
                          <section>
                            ...
                            <p className="text-justify">
                              En los contratos de bienes y servicios, el contratista es responsable por la calidad
                              ofrecida y por los vicios ocultos por un plazo no menor de un año contado a partir de la
                              conformidad otorgada por la entidad contratante. Arti.69.2 literal c).
                            </p>
                          </section>
                          ...
                          <section>
                            ...
                            <p className="text-justify">
                              Las partes pueden acordar modificaciones al contrato menor, siempre que las mismas permitan
                              alcanzar su finalidad de manera oportuna y eficiente y no aumenten el monto ni desnaturalicen
                              el requerimiento. La modificación se perfecciona mediante un acta suscrita por ambas partes
                              que se registra en la Pladicop, de corresponder.
                            </p>
                          </section>
        ...
        <footer className="py-12 border-t border-black/5 text-center text-black/40 text-sm">
          <p>&copy; 2026 Generador de TDR Inteligente &mdash; SUNASS</p>
        </footer>
      </div>
  );
}
